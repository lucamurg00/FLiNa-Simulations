...
# plt.clf()
colors = np.array(["gold","dodgerblue",'yellowgreen','maroon', 'red','blue','green','orange','black', 'purple'])
colors2 = np.array(["midnightblue", "dodgerblue", "skyblue",'#000066'])
...
ax.errorbar(li[9], li[10], li[11], linestyle='none', color=colors[0], marker="X", markeredgecolor=colors[0], markerfacecolor='none', markersize=mm, markeredgewidth=me)
ax.errorbar(li[0], li[1], li[2], linestyle='none', color=colors[3], marker="o", markeredgecolor=colors[3], markerfacecolor='none', markersize=mm, markeredgewidth=me )
ax.errorbar(li[3], li[4], li[5], linestyle='none', color=colors[1], marker="^", markeredgecolor=colors[1], markerfacecolor='none', markersize=mm, markeredgewidth=me)
ax.errorbar(li[6][3:], li[7][3:], li[8][3:], linestyle='none', color=colors[2], marker="h", markeredgecolor=colors[2], markerfacecolor='none', markersize=mm, markeredgewidth=me)

ax.plot(temp_r0, therm_exp_r0(temp_r0), linestyle=':', color=colors[0], linewidth=lw)
ax.plot(temp_r2, therm_exp_r2(temp_r2), linestyle='--', color=colors[3], linewidth=lw)
ax.plot(temp_r4, therm_exp_r4(temp_r4), linestyle='-.', color=d_gold[1], linewidth=lw)
ax.plot(temp_r6, therm_exp_r6(temp_r6), linestyle=':', color=d_blue[1], linewidth=lw)
ax.plot(temp_r8, therm_exp_r8(temp_r8), linestyle='--', color=d_blue[2], linewidth=lw)
ax.plot(temp_r1, therm_exp_r1(temp_r1), linestyle='-.', color=colors[2], linewidth=lw)
...
ax.plot(li[9], l4, linestyle='-', color=colors[0], linewidth=lw)
ax.plot(li[0], l1, linestyle='-', color=colors[3], linewidth=lw)
ax.plot(li[3], l2, linestyle='-', color=colors[1], linewidth=lw)
ax.plot(li[6][3:], l3[3:], linestyle='-', color=colors[2], linewidth=lw)
...
plt.savefig(path + 'Thermal_1.pdf', format='pdf')
plt.show()
plt.clf()
...
dodgerblue_dark = colors2[0]
dodgerblue_light = colors2[1]
...
num_variations = 3
colors_rgba = [tuple(np.linspace(color_dark[i], color_light[i], num_variations)) for i in range(4)]
d_1 = [mcolors.to_hex(color) for color in zip(*colors_rgba)]

dodgerblue_dark = colors2[1]
dodgerblue_light = colors2[2]
...
num_variations = 3
colors_rgba = [tuple(np.linspace(color_dark[i], color_light[i], num_variations)) for i in range(4)]
d_2 = [mcolors.to_hex(color) for color in zip(*colors_rgba)]
...
num_variations = 4
colors_rgba = [tuple(np.linspace(color_dark[i], color_light[i], num_variations)) for i in range(4)]
d_3 = [mcolors.to_hex(color) for color in zip(*colors_rgba)]

ax.plot(exp_ratio_1160, exp_1160, linestyle='--', color=d_3[0], marker="h", markeredgecolor=d_3[0], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(exp_ratio_1215, exp_1215, linestyle='--', color=d_3[1], marker="^", markeredgecolor=d_3[1], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(exp_ratio_1260, exp_1260, linestyle='--', color=d_3[2], marker="X", markeredgecolor=d_3[2], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(exp_ratio_1305, exp_1305, linestyle='--', color=d_3[3], marker="o", markeredgecolor=d_3[3], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)


ax.plot(li_ratio_1000, li_1000, linestyle='-', color=colors2[3], marker="s", markeredgecolor=colors2[3], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(li_ratio_1100, li_1100, linestyle='-', color=colors2[0], marker="X", markeredgecolor=colors2[0], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(li_ratio_1200, li_1200, linestyle='-', color=d_1[1], marker="h", markeredgecolor=d_1[1], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(li_ratio, li_1300, linestyle='-', color=colors2[1], marker="^", markeredgecolor=colors2[1], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(li_ratio, li_1400, linestyle='-', color=d_2[1], marker="d", markeredgecolor=d_2[1], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)
ax.plot(li_ratio, li_1500, linestyle='-', color=colors2[2], marker="o", markeredgecolor=colors2[2], markerfacecolor='none', linewidth=lw, markersize = ms, markeredgewidth=me)


ax.legend([ "Exp: 1160K", "Exp: 1215K", "Exp: 1260K", "Exp: 1305K", "1000K", "1100K", "1200K", "1300K","1400K","1500K"], frameon=True, fontsize='xx-small')
# ax.legend(["Exp: 1305K", "Exp: 1260K", "Exp: 1215K", "Exp: 1160K","1500K", "1400K", "1300K", "1200K", "1100K", "1000"], frameon=True)
...
ax.set_ylim(.85, 1.75)
ax.set_ylabel(r"$\lambda$ (Wm$^{-1}$K$^{-1}$)")
plt.savefig(path + 'Thermal_ratio_1.pdf', format='pdf')
plt.show()
